  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-center min-h-screen bg-gray-100">
      <div className="bg-blue-700 p-8 rounded-lg shadow-lg w-full md:w-1/3">
        <h1 className="text-3xl font-bold text-white mb-6 text-center font-JejuHallasan underline tracking-wide">
          LOGIN
        </h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-center">
            <input
              ...
              } text-black font-bold rounded-lg hover:bg-yellow-500 transition duration-300`}
            />
          </div>
        </form>

        <a
          className="block text-center text-white underline mt-6 font-jeju"
          href="/signup"
        >
